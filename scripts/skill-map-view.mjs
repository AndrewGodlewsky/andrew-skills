...
export function renderMarkdown(map) {
  const escape = value => String(value ?? '').replaceAll('&', '&amp;').replaceAll('\\', '&#92;').replaceAll('[', '&#91;').replaceAll(']', '&#93;').replaceAll('*', '&#42;').replaceAll('_', '&#95;').replaceAll('<', '&lt;').replaceAll('>', '&gt;').replaceAll('|', '&#124;').replaceAll('\n', '<br>').replaceAll('`', '&#96;');
