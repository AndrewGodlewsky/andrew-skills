...
During the architecture review, the owner raised the experience of teammates using CLI and VS Code, possibly with separate installations. The active map now also includes [Define installation ownership and update targeting across Copilot CLI and VS Code](https://github.com/AndrewGodlewsky/andrew-skills/issues/22), an unassigned Wayfinder grilling decision. It is a native prerequisite of [Add per-skill result tables to native GT updates](https://github.com/AndrewGodlewsky/andrew-skills/issues/15).
