...
export function requireText(value, label, max = submissionLimits.input) {
...
// Shared bounded serialization; callers supply their own meaningful sections.
export function prepareHandoff({ title, sections, intro, manifest = [], attachments = [], fileNotice = '' }) {
  title = requireText(title, 'title', 1024);
