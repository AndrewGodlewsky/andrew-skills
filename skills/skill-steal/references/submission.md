Generated from shared creator guidance; edit the maintained source or builder, then rebuild.
...
[clarification guide](clarification.md), plus optional `packageDirectory`.
...
whole handoff partial. Stop on the dependency's security result;
